module.exports = [
  {
    name: "Mercury",
    average_temp: 332, // Fahrenheit
    highest_recorded_temp: 800,
    lowest_recorded_temp: -290,
    planet_type: "Rocky terrestrial",
    ...
    img_url: "https://cdn.mos.cms.futurecdn.net/fjbeeRiPRQjQNhizwy7cWX-1200-80.jpg",
    planet_description: 
  ...
  },
  {
    name: "Venus",
    average_temp: 867,
    highest_recorded_temp: 900,
    lowest_recorded_temp: 870,
    planet_type: "Rocky terrestrial",
    ...
    img_url: "https://s7d1.scene7.com/is/image/CENODS/09911-feature3-venus-social?$twitter$",
    planet_description: 
  ...
  },
  {
    name: "Earth",
    average_temp: 59,
    highest_recorded_temp: 136,
    lowest_recorded_temp: -129,
    planet_type: "Rocky terrestrial",
    ...
    mass_exponent: 24,
    mean_radius: 6371, // km
    img_url: "https://climate.nasa.gov/system/internal_resources/details/original/309_ImageWall5_768px-60.jpg",
    planet_description: 
  ...
  },
  {
    name: "Mars",
    average_temp: -81,
    highest_recorded_temp: 70,
    lowest_recorded_temp: -195,
    planet_type: "Rocky terrestrial",
    density: 3.9335, // g/cm^3,
    dimension: "6,779", // Equatorial diameter
    ...
    mass_exponent: 16,
    mean_radius: 11.1, // km
    img_url: "https://starwalk.space/gallery/images/mars-the-ultimate-guide/1920x1080.jpg",
    planet_description: 
  ...
  },
  {
    ...
    img_url: "https://spaceplace.nasa.gov/all-about-jupiter/en/jupiter_turbulent-atmosphere.en.jpg",
    planet_description: 
  ...
  },
  {
    name: "Saturn",
    average_temp: -288,
    highest_recorded_temp: "Data not available",
    lowest_recorded_temp: "Data not available",
    planet_type: "Gas Giant",
    density: 0.687, // g/cm^3,
    dimension: "116,464", // Equatorial diameter
    ...
    img_url: "https://maxpolyakov.com/wp-content/uploads/2023/10/the-mystery-of-saturns-rings-history-of-the-study-of-the-sixth-planet.jpg",
    planet_description: 
  ...
  },
  {
    ...
    density: 1.27, // g/cm^3,
    dimension: "50,724", // Equatorial diameter
    ...
    img_url: "https://imageio.forbes.com/specials-images/imageserve/5f91806c76fcfa4a1e885d7c/Uranus-will-this-week-be-easy-to-see-for-one-night-only-just-north-of-a-crescent/960x0.jpg?format=jpg&width=960",
    planet_description: 
  ...
  },
  {
    ...
    planet_type: "Ice Giant",
    density: 1.64, // g/cm^3,
    dimension: "49,244", // Equatorial diameter
    ...
    img_url: "https://cdn.mos.cms.futurecdn.net/PezBzd9Fehsq9XWgWMauVV-1200-80.jpg",
    planet_description: 
